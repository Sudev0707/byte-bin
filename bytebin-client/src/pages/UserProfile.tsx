...
import { 
  User, Mail, Calendar, Award, Loader2, Users, UserPlus, UserMinus, 
  Share2, MessageCircle, TrendingUp, Activity, Clock 
} from 'lucide-react';
  ...
  if (!profileQuery.data) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen text-center p-4">
        ...
        <p className="text-muted-foreground mb-6">Unable to load profile data.</p>
    ...
    <div className="container mx-auto space-y-6 p-4 md:p-6 lg:p-8 max-w-6xl min-h-screen">
      ...
      <div className="text-center mb-8">
        <Avatar className="h-32 w-32 mx-auto mb-6 ring-4 ring-background shadow-lg">
          ...
          <AvatarFallback className="h-32 w-32 text-4xl bg-gradient-to-br from-violet-500 to-indigo-500 text-white">
            {initials}
          </AvatarFallback>
        </Avatar>
        <h1 className="text-4xl md:text-5xl font-bold font-display bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent mb-2">
          {user.username}
        </h1>
        ...
        <TabsContent value="stats" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Key metrics and activity overview</CardDescription>
            </CardHeader>
            <CardContent className="grid grid-cols-1 px-4 md:grid-cols-2 lg:grid-cols-4 gap-4 ">
              <div className="group p-6 rounded-xl hover:bg-muted/50 transition-all border cursor-default">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-3xl font-bold text-foreground">{user.problemsSolved?.toLocaleString() || 0}</div>
                </div>
              ...
              <div className="group p-6 rounded-xl hover:bg-muted/50 transition-all border cursor-default">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-3xl font-bold text-foreground">{user.followersCount || 0}</div>
                </div>
              ...
              <div className="group p-6 rounded-xl hover:bg-muted/50 transition-all border cursor-default">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-3xl font-bold text-foreground">{user.followingCount || 0}</div>
                </div>
              ...
              <div className="group p-6 rounded-xl hover:bg-muted/50 transition-all border cursor-default">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-3xl font-bold text-foreground">{user.sharedCount || 0}</div>
                </div>
                <div className="text-sm font-medium text-muted-foreground">Problems Shared</div>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
              ...
              {user.recentProblems && user.recentProblems.length > 0 ? (
                <div className="space-y-3">
                  {user.recentProblems.map((problem, index) => (
                    <div key={problem._id || index} className=" border border-gray-700 flex gap-4 p-2 hover:bg-muted rounded-xl group transition-colors">
                      <div className="flex-1">
                        <h4 className="font-semibold text-md line-clamp-1">{problem.title}</h4>
                        <div className="flex items-center gap-2 mt-1 text-sm text-muted-foreground">
                          <Badge variant="outline" className="px-2 py-1 text-xs">{problem.topic}</Badge>
                          <Badge 
                            variant={
                          ...
                          <span className="text-xs">· {new Date(problem.createdAt).toLocaleDateString()}</span>
                        </div>
                      </div>
                ...
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <p className="text-sm">This user hasn't solved any problems recently</p>
                </div>
              )}
            </CardContent>
          </Card>
