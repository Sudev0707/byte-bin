        ...
        <Tabs defaultValue="account" className="w-full">
          ...
          <TabsContent value="security" className="mt-6">
            <Card>
              ...
              <CardContent>
                {hasPassword ? (
                  <Button onClick={()=> setPasswordDialogOpen(true)} className="w-full">Update Password</Button>
                ) : (
                  <div className="p-4 bg-muted rounded-lg text-muted-foreground text-sm">
                    <Lock className="h-4 w-4 inline mr-2 mb-2" />
                    Password management unavailable for social or email-link
                    accounts. Enable password authentication or manage in your{" "}
                    <a
