...
useEffect(() => {
  ...
  return (
    <div className="flex flex-col h-[500px] rounded-lg bg-background">
      {/* Header */}
      ...
      {/* Messages */}
      <ScrollArea className="flex-1 p-4 space-y-3 bg-slate-950 ">
        {messages.length === 0 ? (
          ...
          messages.map((msg, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={`max-w-[70%] rounded-xl px-4 py-2 mb-2 ${
                    isOwnMessage
